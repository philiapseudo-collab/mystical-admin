      ...
      <div className="shell grid min-h-[88vh] items-center lg:grid-cols-[1.1fr_0.9fr] gap-8">
        <section className="panel-strong p-8 md:p-10">
          ...
          <p className="max-w-2xl text-muted">
            Staff access is restricted. Use your approved work email to continue. If you can authenticate but still lack access,
            an admin needs to activate your staff role inside the back office.
          </p>
        </section>
